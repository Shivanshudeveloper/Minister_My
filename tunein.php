...
<main class="main-content">
    <div class="container-fluid photos">
      ...
      <?php
            include './src/dbh.php';
            $sql = "SELECT * FROM tunein ORDER BY date(date)DESC;";
            $result = mysqli_query($conn, $sql);
            while ($row = mysqli_fetch_assoc($result)) {
                echo '
                <div style="margin-right: 14%" class="col-6 col-md-6 col-lg-4" data-aos="fade-up">
                  <iframe  width="600" height="315" src="'.$row['link'].'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                  </a>
                  <p class="text-light">
                    '.$row['title'].'
                  </p>
