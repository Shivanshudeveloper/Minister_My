    ...
    <?php
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <div class="card mb-2 bg-white">
                    <img  style="width: 15%" src="src/'.$row['file'].'">
                    <div class="card-body">
                        <h2 style="text-align: left;" class="card-title">'.$row['title'].'</h2>
                        <a href="'.$row['link'].'" class="float-right">Visit Link</a>
                        <h4 style="text-align: left;" class="card-title">'.$row['date'].'</h4>
